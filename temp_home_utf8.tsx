...
// ΓöÇΓöÇΓöÇ Intersection Observer Hook ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇΓöÇ Animated Counter ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    <nav style={{
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 72 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          >
            <span style={{ fontSize: 24 }}>{menuOpen ? 'Γ£ò' : 'Γÿ░'}</span>
          </button>
        </div>
      </div>
...
// ΓöÇΓöÇΓöÇ Hero Section ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
const HeroSection: React.FC = () => {
  ...
  return (
    <section style={{
      ...
      {/* Floating icons */}
      {[
        { icon: '≡ƒ⌐║', top: '18%', left: '10%', delay: '0s', size: 52 },
        { icon: '≡ƒÆè', top: '25%', right: '12%', delay: '1s', size: 44 },
        { icon: '≡ƒº¼', bottom: '30%', left: '8%', delay: '2s', size: 40 },
        { icon: 'Γ¥ñ∩╕Å', bottom: '20%', right: '15%', delay: '0.5s', size: 48 },
        { icon: '≡ƒôï', top: '60%', left: '20%', delay: '1.5s', size: 36 },
        { icon: '≡ƒö¼', top: '12%', right: '28%', delay: '2.5s', size: 38 },
      ...
      <p style={{
        ...
        Connect with doctors via HD video, access your encrypted medical records anytime, and manage your entire healthcare journey ΓÇö all in one place.
      </p>
...
// ΓöÇΓöÇΓöÇ Features Section ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
const features: Feature[] = [
  { icon: '≡ƒô╣', title: 'HD Video Consultations', desc: 'Crystal-clear WebRTC-powered video calls with your doctor from anywhere. No app download needed.', color: '#1565C0', bg: '#EFF6FF' },
  { icon: '≡ƒöÆ', title: 'Encrypted Health Records', desc: 'Your EHR is protected with military-grade AES-256 encryption. Only you and your care team can access it.', color: '#00695C', bg: '#F0FDF4' },
  { icon: '≡ƒôà', title: 'Smart Scheduling', desc: 'Book, reschedule or cancel appointments in seconds. Get reminders and never miss a consultation.', color: '#7C3AED', bg: '#F5F3FF' },
  { icon: '≡ƒÆè', title: 'Digital Prescriptions', desc: 'Receive digitally signed prescriptions instantly. Download, share with pharmacies, and track refills.', color: '#B45309', bg: '#FFFBEB' },
  { icon: '≡ƒ¢í∩╕Å', title: 'HIPAA-Aligned Privacy', desc: 'Built with privacy-first architecture. Your data is never sold or shared without explicit consent.', color: '#DC2626', bg: '#FFF5F5' },
  { icon: '≡ƒîÖ', title: '24 / 7 Access', desc: 'Your health records and appointment history are available around the clock, from any device.', color: '#0369A1', bg: '#F0F9FF' },
];
...
// ΓöÇΓöÇΓöÇ How it Works ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
const steps: Step[] = [
  { num: '01', icon: 'Γ£ì∩╕Å', title: 'Create your account', desc: 'Sign up as a patient or doctor in under 2 minutes. No paperwork, no hassle.' },
  { num: '02', icon: '≡ƒöì', title: 'Find the right doctor', desc: 'Browse verified specialists, check availability, and book a slot that works for you.' },
  { num: '03', icon: '≡ƒÆ¼', title: 'Connect & get care', desc: 'Join your video consultation, get a digital prescription, and access your records ΓÇö all in one place.' },
];
...
// ΓöÇΓöÇΓöÇ Testimonials ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇΓöÇ CTA Section ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    <section ref={ref} style={{
      ...
      <div style={{ position: 'relative', maxWidth: 680, margin: '0 auto' }}>
        ...
        <p style={{
          ...
          Join thousands of patients and doctors already using MediVault. Sign up today ΓÇö completely free.
        </p>
        <div style={{
  ...
  <footer style={{ background: '#0F172A', padding: '48px 24px 32px', color: 'rgba(255,255,255,0.5)' }}>
    <div style={{ maxWidth: 1100, margin: '0 auto' }}>
      ...
      <div style={{ borderTop: '1px solid rgba(255,255,255,0.08)', paddingTop: 24, textAlign: 'center', fontSize: '0.8125rem' }}>
        ┬⌐ {new Date().getFullYear()} MediVault. All rights reserved. Built with Γ¥ñ∩╕Å for better healthcare.
      </div>
    </div>
  </footer>
);
